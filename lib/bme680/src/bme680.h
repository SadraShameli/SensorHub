...
#define BME680_I2C_ADDRESS_1 0x76  
#define BME680_I2C_ADDRESS_2 0x77  
...
#define BME680_HEATER_TEMP_MIN 200  
#define BME680_HEATER_TEMP_MAX 400  
#define BME680_HEATER_PROFILES 10   
...
bool bme680_set_oversampling_rates(
    bme680_sensor_t *dev, bme680_oversampling_rate_t osr_t,
...
bool bme680_set_ambient_temperature(bme680_sensor_t *dev, int16_t temperature);
